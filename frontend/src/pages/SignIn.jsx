...
const SignIn = () => {
    ...
    return (
        <>
            {
                isLoading ? <div className='flex align-center justify-center'>
                    <Spinner />
                </div> : <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-white text-gray-800 shadow-lg mx-auto mt-16">
                    ...
                    <form noValidate="" action="" className="space-y-12" onSubmit={handleSubmit(handleFormSubmit)}>
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" placeholder="leroy@jenkins.com" className="w-full px-3 py-2 border rounded-md border-gray-300 bg-gray-100 text-gray-800"
                            ...
                            <div>
                                ...
                                <input type="password" name="password" id="password" placeholder="*****" className="w-full px-3 py-2 border rounded-md border-gray-300 bg-gray-100 text-gray-800"
